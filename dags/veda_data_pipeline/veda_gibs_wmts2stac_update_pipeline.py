...
class VedaGibsWMTSConfig:
    ...
    gibs_url: str # gibs url that has <ows:Identifier> for the indexed STAC collection as well as the associated time dimension.
    ...
    def veda_gibs_wmts2stac_with_update(collection_config: dict, collection_id: str, gibs_url: str):
        ...
        def gibs_wmts2stac_update_task_group(collection: dict, collection_id: str, gibs_url: str) -> None:
            ...
            def branch_update_needed(update_needed: bool) -> str:
                """
                This task branches to either end or to update_nrt_collection_task,
            ...
            branch_choice_instance >> [end, collection_update_task_group(collection, validation_result['latest_layer_date'])]
