...
@dag(
    dag_id="veda_worldview_nrt_data_collection_update",
    schedule="0 0 * * *",
    render_template_as_native_obj=True,
    **dag_args
)
def veda_worldview_nrt_data_collection_update():
    ...
    def worldview_collection_update_task_group(nrt_collection: dict, gibs_url: str ="https://gibs.earthdata.nasa.gov/wmts/epsg4326/best/1.0.0/WMTSCapabilities.xml") -> None:
        ...
        def validation_task_group(gibs_url: str) -> dict:
            ...
            latest_layer_date = extract_latest_nrt_date(xml_string_data, collection_id)
    ...
    @task
    def extract_latest_nrt_date(xml_string: str, collection_id:str='VIIRS_SNPP_DayNightBand_At_Sensor_Radiance') -> str:
        """
