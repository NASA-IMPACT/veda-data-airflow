...
def test_transfer_dry_run(aws_credentials, capsys):
    ...
    bucket_source.create(CreateBucketConfiguration={"LocationConstraint": "us-west-2"})
    bucket_target.create(CreateBucketConfiguration={"LocationConstraint": "us-west-2"})
    # Create some example files that are representative
    # of what the S3 bucket would look like in production
